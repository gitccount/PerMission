...
import com.example.permission.callback.PermissionOriginResultCallBack;
import com.example.permission.callback.PermissionResultCallBack;
import com.example.permission.help.PermissionInfo;
import com.example.permission.help.PermissionUtil;
...
public class MainActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
						...
						.request(
								...
								new PermissionResultCallBack() {
									...
									public void onPermissionGranted(String... permissions) {
										...
										Toast.makeText(MainActivity.this, builder.toString() + " is granted",
									...
									public void onPermissionDenied(String... permissions) {
										...
										Toast.makeText(MainActivity.this, builder.toString() + " is denied",
												Toast.LENGTH_SHORT).show();
									}
									...
									public void onRationalShow(String... permissions) {
										...
										Toast.makeText(MainActivity.this, builder.toString() + " show Rational",
												Toast.LENGTH_SHORT).show();
									}
								});
			}
		...
		mSingleBtn.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {
				PermissionUtil.getInstance().request(MainActivity.this,
						new String[] { Manifest.permission.READ_CALENDAR }, new PermissionOriginResultCallBack() {

							@Override
							public void onResult(List<PermissionInfo> acceptList, List<PermissionInfo> rationalList,
									List<PermissionInfo> deniedList) {
								if (!acceptList.isEmpty()) {
									Toast.makeText(MainActivity.this, acceptList.get(0).getName() + " is accepted",
											Toast.LENGTH_SHORT).show();
								}
								if (!rationalList.isEmpty()) {
									Toast.makeText(MainActivity.this, rationalList.get(0).getName() + " is rational",
											Toast.LENGTH_SHORT).show();
								}
								if (!deniedList.isEmpty()) {
									Toast.makeText(MainActivity.this, deniedList.get(0).getName() + " is denied",
											Toast.LENGTH_SHORT).show();
								}
							}
						});
		...
		mCheckMultiBtn.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {
				Map<String, List<PermissionInfo>> map = PermissionUtil.getInstance()
						.checkMultiPermissions(new String[] { Manifest.permission.CAMERA,
								Manifest.permission.READ_CONTACTS, Manifest.permission.READ_SMS });
