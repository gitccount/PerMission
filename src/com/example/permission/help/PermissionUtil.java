package com.example.permission.help;
...
/**
 * Android6.0权限申请工具类 Created by yanxing on 12/9/15.
 */
public class PermissionUtil {
	 ...
	 * @return PermissionUtil.PERMISSION_GRANTED / PERMISSION_DENIED /
	 *         PERMISSION_RATIONAL or {@code null} if context is not instanceof
	 *         Activity.
	 */
	 ...
	 * @param permissions
	 *            The name of the permission being checked.
	 * @return Map<String, List<PermissionInfo>> or {@code null} if context is
	 *         not instanceof Activity or topActivity can not be find
	 */
	 ...
	 *             if not in the MainThread
	 */
	public void request(@NonNull Fragment fragment, @NonNull String[] permissions,
...
//		}
	 ...
	 * @return
	 */
	private void onResult(List<PermissionInfo> acceptPermissionList, List<PermissionInfo> needRationalPermissionList,
